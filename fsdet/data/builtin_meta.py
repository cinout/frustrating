...
def _get_builtin_metadata(dataset_name):
    ...
    # FIXME: update mvtec meta
    elif dataset_name == "mvtec_fewshot_style_voc":
        return _get_mvtec_fewshot_instances_meta_style_voc()
    elif dataset_name == "mvtec_fewshot_style_coco":
        return _get_mvtec_fewshot_instances_meta_style_coco()
