...
__all__ = ["register_meta_mvtec_style_coco"]


def load_mvteccoco_json(json_file, image_root, metadata, dataset_name):
    """
    FIXME: update these comments later
    Args:
...
def register_meta_mvtec_style_coco(name, metadata, imgdir, annofile):
    DatasetCatalog.register(
        name,
        lambda: load_mvteccoco_json(annofile, imgdir, metadata, name),
    )
